...
import 'package:myproject/FHome/FHthree_.dart';

class FHtwo extends StatelessWidget {
  final String userId;

  FHtwo({required this.userId});
  @override
  ...
  Route _createRoute() {
    return PageRouteBuilder(
      // หน้าที่จะเปิดไป คือ FHthree() (ถ้าเปลี่ยนเป็นหน้าอื่น ให้แก้ที่นี่)
      pageBuilder: (context, animation, secondaryAnimation) => FHthree(userId: userId,),
      ...
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
        ...
        return SlideTransition(
          ...
          child: FadeTransition(
            ...
            child: child, // หน้าจอที่จะแสดง (FHtwo)
          ),
        );
      },
    );
